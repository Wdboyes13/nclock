...
void App::do_kbdb_win() {
    ...
    mvwprintw(dialog, 11, 2, "Normal Mode: N");
    mvwprintw(dialog, 12, 2, "Stopwatch Mode: S");
    mvwprintw(dialog, 13, 2, "Timer Mode: T");
    mvwprintw(dialog, 14, 2, "Start/Stop Timer/Stopwatch: Space");
    mvwprintw(dialog, 15, 2, "Reset Timer/Stopwatch: R");
