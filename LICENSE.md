...
### FIGlet
This project redistributes 1 file from the FIGlet package: [`standard.flf`](/standard.flf).
...
### libfiglet
This project redistributes a combined include file from the libfiglet package: [`include/libfiglet.hpp`](/include/libfiglet.hpp).
